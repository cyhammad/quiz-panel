...
import { filterByAnalytics, filterBytype,filterbySearch, sortRows } from "../utility/filter";
...
export default function CategoriesNews() {
  ...
  const currentData = filteredquizCategories.slice(indexOfFirstData, indexOfLastData)
  ...
  return (
    <div className="w-full min-h-screen sm:max-w-screen-2xl px-6 sm:px-8 xl:px-0 xl:py-6 sm:mx-auto ">
      <div className="">
        ...
        <div className="my-8 space-y-4 xl:space-y-0 xl:flex items-center justify-between w-full">
          ...
          <div className="sm:flex sm:flex-wrap gap-4">
            ...
            <button
              onClick={() => navigate("/add-quiz-category")}
              ...
              return (
                ...
                >
                  ...
                  <div className="col-span-8 flex items-center gap-2">
                    <img className="object-cover h-8 w-8 rounded-full" src={category.image} alt="" />
      ...
      <Pagination perPage={perPage} totalData={filteredquizCategories.length} paginate={paginate} currentPage={currentPage}/>
